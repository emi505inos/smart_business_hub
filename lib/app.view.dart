  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(create: (context) => CreateIncomeBloc(FirebaseIncomeRepo())..add(CreateIncome(Income.empty)),),
        BlocProvider(create: (context) => GetIncomeBloc(FirebaseIncomeRepo())..add(GetIncome()),),
        BlocProvider(create: (context) => CreateExpenseBloc(FirebaseExpenseRepo())..add(CreateExpense(Expense.empty)),),
        BlocProvider(create: (context) => GetExpenseBloc(FirebaseExpenseRepo())..add(GetExpense()),),
        BlocProvider(create: (context) => CreateCategoryBloc(FirebaseCategoryRepo())..add(CreateCategory(Category.empty)),),
        BlocProvider(create: (context) => GetCategoriesBloc(FirebaseCategoryRepo())..add(GetCategories()),),
        BlocProvider(create: (context) => CreateProductBloc(FirebaseProductRepo())..add(CreateProduct(Product.empty)),),
        BlocProvider(create: (context) => GetProductBloc(FirebaseProductRepo())..add(GetProduct()),),
        BlocProvider(create: (context) => CreateClientsBloc(FirebaseClientsRepo())..add(CreateClient(Clients.empty)),),
        BlocProvider(create: (context) => GetClientsBloc(FirebaseClientsRepo())..add(GetClients()),),
        BlocProvider(create: (context) => CreateEmployeeBloc(FirebaseEmployeeRepo())..add(CreateEmployee(Employee.empty)),),
        BlocProvider(create: (context) => GetEmployeeBloc(FirebaseEmployeeRepo())..add(GetEmployee()),),
...
Future<bool> _userHasCompany(String userId) async {
  ...
  return userDoc.exists && userDoc.data()?['business'] != null;
}
