...
class ToPayDebts extends StatefulWidget {
  final  String  debtId;
  const ToPayDebts({super.key, required this.debtId});

  @override
  State<ToPayDebts> createState() => _ToPayDebtsState();
}

class _ToPayDebtsState extends State<ToPayDebts> {
