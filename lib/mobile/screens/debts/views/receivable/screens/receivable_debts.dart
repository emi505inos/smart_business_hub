...
class ReceivableDebts extends StatefulWidget {
  final  String  clientId;
  const ReceivableDebts({super.key, required this.clientId});

  @override
  State<ReceivableDebts> createState() => _ReceivableDebtsState();
}

class _ReceivableDebtsState extends State<ReceivableDebts> {
